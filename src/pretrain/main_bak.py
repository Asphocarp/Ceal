...
def main(params):
    ...
    scheduler: CosineAnnealingLR = utils.build_lr_scheduler(optimizer=optimizer, **utils.parse_params(params.scheduler)) if params.scheduler is not None else None
    ...
    start_epoch = 0
    # ! copy ckpt to slaves before resuming
